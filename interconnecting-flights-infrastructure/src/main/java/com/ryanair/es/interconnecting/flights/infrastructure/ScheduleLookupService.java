...
public class ScheduleLookupService {
    ...
    private static String END_POINT_SCHEDULE = "https://api.ryanair.com/core/3/routes";
    ...
    public CompletableFuture<List<Route>> findRoute() throws InterruptedException {
        ...
        ResponseEntity<List<Route>> rateResponse = restTemplate.exchange(END_POINT_SCHEDULE, HttpMethod.GET, null,
